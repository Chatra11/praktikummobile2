...
import com.example.modul4.databinding.ActivityMainhewanBinding
import java.util.*

class MainactivityHewan : AppCompatActivity() {
    private lateinit var binding: ActivityMainhewanBinding
    private lateinit var locale:Locale
    private var current = "en"
    private var currenlang:String? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityMainhewanBinding.inflate(layoutInflater)
